...
namespace data.test.app.Database
{
    ...
    public class TestModel
    {
        ...
        public string CONTACT_TO_CUSTOMER_DATE { get; set; }
        public string PERSONEL_FLAG { get; set; }
        public string ACTIVITY { get; set; }
        public string MARITAL_STATUS { get; set; }
        public string SGK_FLAG { get; set; }
        public string EDUCATION_STATUS { get; set; }
        public string EMAIL_PERMISSION { get; set; }
        public string GSM_PERMISSION { get; set; }
        public string BUSINESS_LINE { get; set; }
        public string UNIT_STATUS { get; set; }
        public string DEVICE_ID { get; set; }
        public string BEFORE_CEP_TEL { get; set; }
        public string BEFORE_EMAIL { get; set; }
    }
}
